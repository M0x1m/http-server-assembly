...
#   [cfg] table-view-dirlisting = 1 << 13
	...
	CFG_KEYWORDS:
		.asciz "server-port="
		.asciz "server-binding-device-address="
		.asciz "server-root-directory="
		.asciz "default-directory-file-name="
		.asciz "enable-default-directory-files="
		.asciz "enable-custom-404-page="
		.asciz "404-page-file-path="
		.asciz "enable-custom-403-page="
		.asciz "403-page-file-path="
		.asciz "minimal-openning-permission="
		.asciz "client-request-timeout="
		.asciz "enable-dirlisting="
		.asciz "mimetypes-file-path="
		.asciz "enable-hidden-files-in-dirlisting="
